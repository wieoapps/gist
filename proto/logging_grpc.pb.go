...
const (
	LoggingService_Log_FullMethodName = "/gist.LoggingService/Log"
)
...
type LoggingServiceClient interface {
	Log(ctx context.Context, in *LogRequest, opts ...grpc.CallOption) (*LogAck, error)
}
...
func (c *loggingServiceClient) Log(ctx context.Context, in *LogRequest, opts ...grpc.CallOption) (*LogAck, error) {
...
type LoggingServiceServer interface {
	Log(context.Context, *LogRequest) (*LogAck, error)
...
func (UnimplementedLoggingServiceServer) Log(context.Context, *LogRequest) (*LogAck, error) {
...
var LoggingService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "gist.LoggingService",
