...
func (t *Transaction) db() proto.MySQLServiceClient {
...
func (t *Transaction) Commit() error {
	...
	ack, err := t.db().Commit(context.Background(), &proto.TransactionHandle{TransactionHandle: t.handle})
	if err != nil {
...
func (t *Transaction) Rollback() error {
	...
	ack, err := t.db().Rollback(context.Background(), &proto.TransactionHandle{TransactionHandle: t.handle})
	if err != nil {
